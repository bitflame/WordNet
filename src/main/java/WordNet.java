...
public class WordNet {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("The distance expected between the nouns individual and edible_fruit should be 7, and it is: " +
                wordNet.distance("individual", "edible_fruit"));
        StdOut.println("The distance between the nouns white_marlin and mileage should be 23, and it is: " +
                wordNet.distance("white_marlin", "mileage"));
        StdOut.println("The distance between the nouns Black_Plague and black_marline should be 33, and it is:" +
                wordNet.distance("Black_Plague", "black_marlin"));
        StdOut.println("The distance between the nouns American_water_spaniel and histology should be 27 and it is: " +
                wordNet.distance("American_water_spaniel", "histology"));
        StdOut.println("The distance between the nouns Brown_Swiss, and barrel_roll should be 29, and it is: " +
                wordNet.distance("Brown_Swiss", "barrel_roll"));
        StdOut.println("The distance between the nouns group_action and event should be 1, and it is: " +
